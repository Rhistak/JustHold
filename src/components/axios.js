...
let r13 =
  "https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&ids=&order=market_cap_desc&per_page=250&page=13&sparkline=false&price_change_percentage=1h";
let r14 =
  "https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&ids=&order=market_cap_desc&per_page=250&page=14&sparkline=false&price_change_percentage=1h";
let r15 =
  "https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&ids=&order=market_cap_desc&per_page=250&page=15&sparkline=false&price_change_percentage=1h";
let r16 =
  "https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&ids=&order=market_cap_desc&per_page=250&page=16&sparkline=false&price_change_percentage=1h";
let r17 =
  "https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&ids=&order=market_cap_desc&per_page=250&page=17&sparkline=false&price_change_percentage=1h";
let r18 =
  "https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&ids=&order=market_cap_desc&per_page=250&page=18&sparkline=false&price_change_percentage=1h";
